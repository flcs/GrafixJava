...
public class FormAtualizarPadrao extends javax.swing.JDialog implements FormAtualizacao {
    ...
    private void iniciarCampos() {
        ...
        if (vendor.equals("yahoo")) {
            ...
            if (ultimaAtualizacao == null) {
                String mensagem = "Erro ao ler data da ï¿½ltima atualizaï¿½ï¿½o da base de dados localizada em " +
                        Controle.getConfiguracoesGrafix().getPathBaseDados() +
                        ".\n Provavelmente a base de dados nï¿½o estï¿½ no formato do grafix, nï¿½o serï¿½ possï¿½vel realizar a atualizaï¿½ï¿½o.";
    ...
    public void cancelarAtualizacao() {
        informarLog("******* Aguarde, atualizaï¿½ï¿½o sendo cancelada ... ");
